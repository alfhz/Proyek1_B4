...
from input_handler import input_numbers, input_choice
    ...
    while True:
        ...
        match choice:
            case "1":
                ...
                display_result("Mean", mean)
            case "2":
                numbers = input_numbers()
                median = calculate_median(numbers)
                display_result("Median", median)
            case "3":
                numbers = input_numbers()
                maximum = calculate_maximum(numbers)
                display_result("Maximum", maximum)
            case "4":
                numbers = input_numbers()
                minimum = calculate_minimum(numbers)
                display_result("Minimum", minimum)
            case "5":
                numbers = input_numbers()
